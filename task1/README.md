...
Решение: если работает бейзлайн, то использую его, иначе использую зафайнтюненную MaskRCNN, с помощью которой предсказываю маску, после чего бинаризую и вытаскиваю контур с помощью методов OpenCV.
